...
func (app *application) routes() http.Handler {
	...
	router.Handler(http.MethodGet, "/snippet/view/:id", dynamic.ThenFunc(app.sinppetView))
	...
	router.Handler(http.MethodPost,"/users/logout",dynamic.ThenFunc(app.userLoginPost))
